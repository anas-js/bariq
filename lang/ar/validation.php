...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | تحتوي السطور التالية على رسائل الخطأ الافتراضية التي يستخدمها
    | مُحقق القيم. بعض هذه القواعد لها أكثر من إصدار، مثل قواعد الحجم.
    | يمكنك تعديل كل من هذه الرسائل هنا حسب الحاجة.
    |
    */
    ...
    'contains' => 'يحتاج حقل :attribute إلى قيمة مفقودة.',
    ...
    'hex_color' => 'يجب أن يكون حقل :attribute لونًا هكسادسيا صالحًا.',
    ...
    'prohibited' => 'يُحظر استخدام حقل :attribute.',
    'prohibited_if' => 'يُحظر استخدام حقل :attribute عندما يكون :other هو :value.',
    'prohibited_unless' => 'يُحظر استخدام حقل :attribute إلا إذا كان :other ضمن :values.',
    'prohibits' => 'يُحظر حقل :attribute من أن يكون :other موجودًا.',
    ...
    |--------------------------------------------------------------------------
    |
    | يمكنك تحديد رسائل التحقق المخصصة للسمات باستخدام
    | القاعدة "attribute.rule" لتسمية الرسائل. هذا يجعل من السهل
    | تحديد رسالة مخصصة معينة لقاعدة سمة معينة.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | تُستخدم السطور التالية لاستبدال القيم الافتراضية للسمات
    | بشيء أكثر سهولة في القراءة مثل "عنوان البريد الإلكتروني" بدلاً من
    | "البريد الإلكتروني". وهذا يساعد في جعل رسالتنا أكثر تعبيرًا.
    |
    */

    'attributes' => [
        'email' => 'البريد الإلكتروني او المستخدم',
